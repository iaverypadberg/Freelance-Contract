...
module UnitTests.EndingTests (tests) where
...
-- 1. Contract will never reach its ending point
-- 2. One party must always cancel the contract in the specified time

-- Test Cases Covered - Basic Params
--  Test 1 : Accept on time, I1, EE
--  Test 2 : Accept on time, I1, FE
--  Test 3 : Accept on time, I1, C1, EE
--  Test 4 : Accept on time, I1, C1, FE
--  Test 5 : Accept on time, I1, I2, EE
--  Test 6 : Accept on time, I1, I2, FE
--  Test 7 : Accept on time, I1, C1, I2, EE
--  Test 8 : Accept on time, I1, C1, I2, FE
--  Test 9 : Accept on time, I1, C1, I2, C2, EE
-- Test 10 : Accept on time, I1, C1, I2, C2, FE
-- Test 11 : Accept on time, C1, I1, C2, I2, C3, EE
-- Test 12 : Accept on time, C1, I1, C2, I2, C3, FE
-- Test 13 : Accept on time, C1, I1, I2, C3, EE
-- Test 14 : Accept on time, C1, I1, I2, C3, EE
-- Test 15 : Accept on time, C1, I1, I2, EE
-- Test 16 : Accept on time, C1, I1, I2, EE
...
tests = testGroup "Tests" [test1 empParams]
-- Basic Params
...
test1 p = checkPredicate
    ...
    (     assertNoFailedTransactions
     .&&. walletFundsChange (Wallet 1) (Ada.lovelaceValueOf  (-3_000_000))
     .&&. walletFundsChange (Wallet 2) (Ada.lovelaceValueOf   3_000_000)
    )
    $ trace1 p
